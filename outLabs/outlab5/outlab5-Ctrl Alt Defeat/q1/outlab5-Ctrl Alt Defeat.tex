...
\cline{3-11}
                                     				 &      & \multicolumn{5}{m{36mm}|}{\textbf{Basic Properties}} & \multicolumn{4}{m{30mm}|}{\textbf{Readability}} \\ \cline{3-11} 
                                     				 &      & \textbf{WC}  & \textbf{SC}  & \textbf{C-W}   & \textbf{S-W}  & \textbf{W-S} & \textbf{FK}  & \textbf{GF}  & \textbf{SMOG}  & \textbf{LEX}  \\ \cline{1-11}
\multicolumn{1}{|C{16mm}|}{\multirow{2}{*}{$Baseline$}} & Mean & 0.84     & 0.41     & \textbf{0.56}     & \textbf{0.46}     & \textbf{0.55}     & \textbf{0.60}     & 0.56     & 0.57       & 0.63      \\ \cline{2-11} 
\multicolumn{1}{|C{16mm}|}{}                          & SD   & 0.07     & 0.08     & 0.06     & 0.07     & 0.05     & 0.05     & 0.06     & 0.07       & 0.05      \\ \cline{1-11}
\end{tabular}}}
\vspace{.1mm}
{\fontsize{9}{11}\selectfont
\noindent\makebox[\textwidth]{
...
\multirow{2}{*}{$ScaComp_h$}                       & Mean & 0.89     & 0.46   & 0.53     & 0.43     & 0.53     & 0.58     & 0.54     & 0.56       & 0.62      \\ \cline{2-11}
                                                & SD   & 0.05     & 0.08     & 0.05     & 0.06     & 0.06     & 0.05     & 0.05     & 0.06       & 0.05      \\ \cline{1-11}
\end{tabular}}}
{\fontsize{9}{11}\selectfont
\noindent\makebox[\textwidth]{
\begin{tabular}{|C{16mm}|C{7.5mm}|C{6.5mm}|C{6.5mm}|C{9mm}|C{7mm}|C{7mm}|C{6.5mm}|C{7mm}|C{9.5mm}|m{7mm}|}
...
\multirow{2}{*}{$ScaComp_l$}                       & Mean & \textbf{0.92}     & \textbf{0.48}     & 0.55     & 0.45     & 0.53     & 0.59     & \textbf{0.58}     & \textbf{0.61}       & \textbf{0.64}      \\ \cline{2-11} 
                                                & SD   & 0.04     & 0.07     & 0.05     & 0.04     & 0.05     & 0.04     & 0.04     & 0.04       & 0.04      \\ \cline{1-11}
\end{tabular}}}
