...
\usepackage{geometry}\geometry{a4paper,width=6in,left=3cm,top=1in,bottom=1in}
\usepackage{multirow}
\usepackage{amsmath} 
...
\multicolumn{1}{|m{2cm}|}{\multirow{2}{*}{$Baseline$}} & Mean & 0.84     & 0.41     & \textbf{0.56}     & \textbf{0.46}     & \textbf{0.55}     & \textbf{0.60}     & 0.56     & 0.57       & 0.63      \\ \cline{2-11} 
\multicolumn{1}{|m{2cm}|}{}                          & SD   & 0.07     & 0.08     & 0.06     & 0.07     & 0.05     & 0.05     & 0.06     & 0.07       & 0.05      \\ \hline
\end{tabularx}}
% \resizebom{\textwidth}{!}
\vspace{.1mm}
{\footnotesize
