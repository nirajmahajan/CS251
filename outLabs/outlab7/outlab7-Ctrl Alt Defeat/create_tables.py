...
curs.execute(
    ...
    season_year INTEGER,
    team1 INTEGER REFERENCES MATCH (match_id),
    team2 INTEGER REFERENCES MATCH (match_id),
    battedfirst INTEGER REFERENCES MATCH (match_id),
    battedsecond INTEGER REFERENCES MATCH (match_id),
    venue_name TEXT,
    city_name TEXT,
    country_name TEXT,
    toss_winner TEXT,
